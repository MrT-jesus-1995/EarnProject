        ...
        <Container maxW={"9xl"}>
            ...
            <Box gap={6} p={12}>
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 2.5 www.kssintertech.co.th
                    </Badge>
                </Box>
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    <Image src="https://busarasite.files.wordpress.com/2016/02/30.jpg" />
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 2.6 busarasite.files.wordpress.com
                    </Badge>
                </Box>
                <Text fontSize={"3xl"} color="#1B2430">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 2.11 itmoomoo.files.wordpress.com
                    </Badge>
                </Box>
                <Text fontSize={"3xl"} color="#142850">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    />
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 2.12 marvel-b1-cdn.bc0a.com
                    </Badge>
                </Box>
                <Text fontSize={"3xl"} color="#160F30">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 2.13 marvel-b1-cdn.bc0a.com
                    </Badge>
                </Box>
                <Text fontSize={"3xl"} color="#160F30">
                ...
                <Text fontSize={"3xl"} color="#472D2D">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    />
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 2.14 nganbrikarkhxngkhxmphiwtexr
                    </Badge>
                </Box>
                <Text fontSize={"3xl"} color="#160F30">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    />
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 2.15 upload.wikimedia.org
                    </Badge>
                </Box>
