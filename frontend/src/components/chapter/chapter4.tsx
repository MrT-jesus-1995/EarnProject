import { Container, Heading, Stack, Text, Box, Image, Badge, ListItem, OrderedList, extendTheme, ChakraProvider } from "@chakra-ui/react"
        ...
        <ChakraProvider theme={theme}>
            ...
            <Container maxW={"9xl"}>
                ...
                <Box gap={6} p={12}>
                    ...
                    <Text fontSize={"3xl"} color="#493323">
                        หรือนิยมเรียกง่าย ๆ ว่า “สายยูทีพี” เป็นสายเคเบิลขนาดเล็กคล้ายสายโทรศัพท์ 1 เส้น ดังรูปที่ 4.1 ภายในประกอบด้วยสายเกลียวคู่ 4
                        คู่ (8 เส้น) ตีเป็นเกลียวคู่ ๆ จึงมีขนาดกะทัดรัดแต่ลักษณะการเดินสายจะต้องเชื่อมต่อจากคอมพิวเตอร์หรืออุปกรณ์ในระบบเครือข่าย
                    ...
                    <Text fontSize={"3xl"} color="#493323">
                        ...
                        สามารถป้องกันสัญญาณรบกวนจากคลื่นแม่เหล็กไฟฟ้าได้ดี มีความคงทนและส่งข้อมูลได้ไกล
                        ในเครือข่ายคอมพิวเตอร์ใช้สายโคแอกเชียลที่เรียกว่า อาร์จี-58/ยู (RG-58/U) ที่มีความต้านทานทางไฟฟ้า 50 โอห์ม
                        สายโคแอกเชียลที่ใช้สำหรับระบบเครือข่ายมี 2 แบบ คือ สายโคแอกเชียลแบบบาง ออกแบบภายใต้สถาปัตยกรรมทินอีเทอร์เน็ต(Thin Ethernet)
                        ในมาตรฐาน 10BASE2 มีขนาดเส้นผ่านศูนย์กลางประมาณ 0.81 มิลลิเมตร มีความสามารถส่งข้อมูลด้วยความเร็ว 10
                        เมกะบิตต่อวินาทีระยะการเชื่อมต่อได้ไกล 185 เมตร และสายโคแอกเชียลออกแบบภายใต้สถาปัตยกรรมทิคอีเทอร์เน็ต (Thick Ethernet)
                        ใช้ในมาตรฐาน 10BASE5 เป็นสายที่มีเส้นผ่านศูนย์กลางประมาณ 2.17 มิลลิเมตร มีความสามรถในการส่งข้อมูลด้วยความเร็ว 10
                        เมะกะบิดต่อวินาที ในระยะการเชื่อมต่อได้ไกล 500 เมตร ซึ่งนิยมนำมาใช้เชื่อมต่อเส้นทางหลักสำหรับการส่งข้อมูล
                    </Text>
                    <Stack display="flex" mt="2" alignItems="center" py={{ base: 10, md: 18 }}>
                    ...
                    <Text fontSize={"3xl"} color="#493323">
                        ...
                        เส้นใยแก้วนำแสงมีข้อดีกว่าสายแบบคู่บิดเกลียวและสายโคแอกเชียล คือ
                        มีอัตราความเร็วในการสื่อสารที่สูงกว่าและส่งได้ในระยะทางที่ไกลกว่า
                    ...
                    <Text fontSize={"3xl"} color="#493323">
                        ...
                        ครอบคลุมพื้นที่ของโลกได้มากกว่า แต่การใช้ดาวเทียมนั้นคำใช้จ่ายจะสูง
                        เนื่องจากต้องมีการสงดาวเทียมต้องมีสถานีภาคส่งและสถานีภาครับ และสำหรับดาวเทียมบางดวงที่อยู่สูงจากพื้นโลกมาก ๆ
                        จะทำให้เกิดปัญหาความล่าช้าของสัญญาณแสดงการสื่อสารผ่านดาวเทียม
                    </Text>
                    <Stack display="flex" mt="2" alignItems="center" py={{ base: 10, md: 18 }}>
                    ...
                    <Text fontSize={"3xl"} color="#493323">
                        การใช้คลื่นวิทยุทำให้การสื่อสารสามารถทำได้บริเวณกว้าง
                        สามารถใช้ได้ทั้งการสื่อสารข้อมูลภายในอาคารหรือการสื่อสารข้อมูลระดับจังหวัด
                        โดยผู้ส่งจะต้อวมีเครื่องส่งสัญญาณและผู้รับจะต้องมีเครื่องรับสัญญาณ การสื่อสารระบบเครือข่ายคอมพิวเตอร์โดยใช้คลื่นวิทยุนี้
                        ได้แก่ ระบบแลนไร้สายและระบบบลูทูล ที่ใช้ในการสื่อสารกันที่มีระยะทางช่วงระยะ 10 เมตร ถึง 100 เมตร
                    </Text>
                    <Stack display="flex" mt="2" alignItems="center" py={{ base: 10, md: 18 }}>
