        ...
        <Container maxW={"9xl"}>
            ...
            <Box gap={6} p={12}>
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    />
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 4.2 รูปร่างของสายเกลียวคู่แบบมีฉนวนหุ้มhttps://vipavan.wordpress.com/author/vipavan/ [AUGUST 1, 2017].
                    </Badge>
                </Box>
                <Heading fontSize={"3xl"} color="#493323">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        ...
                        https://sites.google.com/site/it39000009/hnwy-thi-4?tmpl=%2Fsystem%2Fapp%2Ftemplates%2Fprint%2F&showPrintDialog=1
                    </Badge>
                </Box>
                <Heading fontSize={"3xl"} color="#493323">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    />
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 4.4 เส้นใยแก้วนำแสง https://thaismegp.com/product/6139936090481a8833594b92
                    </Badge>
                </Box>
                <Text fontSize={"3xl"} color="#493323">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    />
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 4.5 เส้นใยแก้วนำแสงแบบมัลติโหมด http://www.geocities.ws/fiber-optic/type.html
                    </Badge>
                </Box>
                <Heading fontSize={"3xl"} color="#493323">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    />
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 4.6 คลื่นไมโครเวฟ https://witpoko.com/?p=6762 [21/8/2021].
                    </Badge>
                </Box>
                <Heading fontSize={"3xl"} color="#493323">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    ...
                    <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                        รูปที่ 4.9 ระบบอินฟราเรด https://www.neonics.co.th/
                    </Badge>
                </Box>
                <Heading fontSize={"3xl"} color="#493323">
