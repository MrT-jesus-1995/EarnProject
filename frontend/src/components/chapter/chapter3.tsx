            ...
            <Container maxW={"9xl"}>
                ...
                <Box gap={6} p={12}>
                    ...
                    <Text fontSize={"3xl"} color="#251B37">
                        ...
                        เป็นการเชื่อมต่อโดยใช้คลื่นวิทยุที่เหมือนกับมาตรฐาน 802.11 ใช้ไฟฟ้าต่ำกว่า อุปกรณ์จึงมีขนาดเล็ก
                        ส่งผลให้การรบกวนของคลื่นมีน้อยลง มีระยะทางการใช้งานได้ไกลประมาณ 10 เมตร (30ฟุต) และทำงานที่ความเร็วประมาณ 700 กิโลบิตต่อวินาที
                    </Text>
                    ...
                    <Text fontSize={"3xl"} color="#16213E">
                        ถูกคิดค้นตั้งแต่ทศวรรษ 1970 เป็นเทคโนโลยีชั้นนำของเครือข่ายท้องถิ่น
                        อีเธอร์เน็ตตั้งอยู่บนมาตรฐานการส่งข้อมูลหรือโพรโทคอลCSMA/CD (Carrier Sense Multiple Access with Collision Detection)
                        ใช้สำหรับการเข้าใช้สื่อกลางการส่งสัญญาณที่แชร์กันระหว่างสถานีหรือโหนดต่าง ๆ มีขั้นตอนคือ เมื่อโหนดใด ๆ
                        ต้องการส่งข้อมูลต้องคอยฟังก่อนว่ามีโหนดอื่นกำลังส่งข้อมูลอยู่หรือไม่ ถ้ามีให้รอจนกว่าเครื่องนั้นจะทำการส่งข้อมูลเสร็จสิ้น
                        แล้วค่อยเริ่มส่งข้อมูล และในขณะที่กำลังส่งข้อมูลนั้น ต้องตรวจสอบว่ามีการชนกันของข้อมูลเกิดขึ้นหรือไม่
                        ถ้าเกิดการชนกันของข้อมูลให้หยุดการส่งข้อมูลทันที แล้วเริ่มกระบวนการส่งข้อมูลใหม่อีกครั้ง อีเธอร์เน็ตจะใช้สื่อกลางร่วมกัน
                        เรียกว่า บัส (Bus) จึงมีโหนดที่ส่งข้อมูลได้แค่โหนดเดียวในขณะในขณะหนึ่ง
                        ...
                        เมื่อมีจำนวนโหนดเพิ่มมากขึ้น ความน่าจะเป็นที่ข้อมูลชนกันจะเพิ่มขึ้นตามไปด้วย อีเธอร์เน็ตจะมีอัตราการส่งข้อมูลหรือแบนด์วิธที่
                        10 Mbps ในขณะที่ฟาสต์อรเธอร์เน็ต (Fast Ethernet) มีการทำงานคล้าย ๆ กัน เพียงแค่มีอัตราข้อมูลที่สูงกว่า 10 เท่า
                        ส่วนกิกะบิตอีเธอร์เน็ต (Gigabit thernet) มีอตราข้อมูลสูงสุดคือ 1000 Mbps เรียกว่าเทนกิกะบิตอีเธอร์เน็ต (10G Ethernet)
                    </Text>
                    <Stack display="flex" mt="2" alignItems="center" py={{ base: 10, md: 18 }}>
                    ...
                    <Text fontSize={"3xl"} color="#16213E">
                        เป็นมาตรฐานการรับส่งข้อมูลที่กำหนดโดย ITU-T (Internaional Telecommuication Standard Sector) ซึ่งจะรวมบริการต่าง ๆ เช่น
                        ข้อมูลเสียง วิดีโอเข้าด้วยกันแล้วส่งเป็นเซลล์ (Cell) ข้อมูลมีขนาดเล็กและคงที่เป็นเครือข่ายที่รองรับแบนด์วิธตั้งแต่ Mbps จนถึง
                        Gbps
                    </Text>
                    <Stack display="flex" mt="2" alignItems="center" py={{ base: 10, md: 18 }}>
