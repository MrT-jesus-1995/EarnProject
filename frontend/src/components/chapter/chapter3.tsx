        ...
        <Container maxW={"9xl"}>
            ...
            <Box gap={6} p={12}>
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    <Image
                        src="https://sites.google.com/site/kanyaphat16305/_/rsrc/1423198767334/kherux-khay-khxmphiwtexr/kherux-khay-swn-bukhkhl-hrux-phaen-personal-area-network-pan/Personal_Area_Network.png"
                        alt="Dan Abramov"
                    />
                </Box>
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    <Image src="https://mindphp.com/images/stories/encyclopedia/atm2.gif" alt="Dan Abramov" />
                </Box>
                <Heading fontSize={"3xl"} color="#16213E">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    <Image src="https://tuemaster.com/wp-content/uploads/2021/03/123456.png" alt="Dan Abramov" />
                </Box>
                <Heading fontSize={"3xl"} color="#16213E">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    <Image
                        src="https://sites.google.com/site/wwwrujbodyslamcom/_/rsrc/1344327210559/kar-suxsar-khxmul-laea-kherux-khay/prapheth-khxng-kherux-khay/Cc751420.wan_msp02_big%28l%3Den-us%29.gif?w=144"
                        alt="Dan Abramov"
                    />
                </Box>
                <Heading fontSize={"3xl"} color="#16213E">
                ...
                <Box align={"center"} spacing={{ base: 5, md: 7 }} py={{ base: 10, md: 18 }}>
                    <Image
                        src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/LAN_WAN_scheme.svg/1200px-LAN_WAN_scheme.svg.png"
                        alt="Dan Abramov"
                    />
                </Box>
