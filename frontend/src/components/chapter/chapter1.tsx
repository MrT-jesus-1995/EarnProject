import { Container, Heading, Stack, Text, Box, Image, Badge, ChakraProvider, extendTheme } from "@chakra-ui/react"
        ...
        <ChakraProvider theme={theme}>
            ...
            <Container maxW={"9xl"}>
                <Stack textAlign={"center"} align={"center"} spacing={{ base: 8, md: 10 }} py={{ base: 20, md: 28 }}>
                    <Heading fontWeight={600} fontSize={{ base: "2xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} fontFamily={"Mali"}>
                ...
                <Box gap={6} p={12}>
                    <Text fontSize={"3xl"} color="#00005C">
                        ...
                        เพื่อทำให้คอมพิวเตอร์แต่ละเครื่องสามารถทำการแลกเปลี่ยนข้อมูล การประมวลผลร่วมกันและกันได้
                        สามารถใช้ทรัพยากรในเครือข่ายร่วมกันได้ เช่น เครื่องพิมพ์ ซีรีดอม สแกนเนอร์ ฮาร์ดดิสก์ เป็นต้น
                    </Text>
                    <Text fontSize={"3xl"} color="#00005C">
                    ...
                    <Stack display="flex" mt="2" alignItems="center" py={{ base: 10, md: 18 }}>
                        <Image src="https://www.conceptdraw.com/How-To-Guide/picture/computer-network.png" />
                        <Badge borderRadius="full" px="2" colorScheme="teal" fontSize={"md"}>
                    ...
                    <Text fontSize={"3xl"} color="#0002A1">
                        เพื่อให้มีการแลกเปลี่ยนข้อมูลกันได้ระหว่างผู้ใช้อย่างมีประสิทธิภาพ ใช้ทรัพยากรร่วมกันได้
                        สร้างความน่าเชื่อถือและความปลอดภัยของระบบ เพิ่มความสะดวกในด้านการสื่อสารโดยจุดประสงค์แต่ละข้อมีรายละเอียดดังต่อไปนี้
                    </Text>
                    ...
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#0002A1" p={6}>
                        1.2.2 เพื่อให้สามารถใช้ทรัพยากรร่วมกันได้ ในหน่วยงาน
                        สามารถใช้งานฮาร์ดแวร์หรือซอฟต์แวร์ที่อยู่ในระบบเครือข่ายเดียวกันร่วมกันได้ เช่น การแชร์เครื่องพิมพ์
                        โดยทุกเครื่องในระบบเครือข่าย สามารถใช้งานเครื่องพิมพ์เครื่องนั้นได้ โดยไม่ต้องสลับกันไว้ ส่วนการใช้ซอฟต์แวร์ร่วมกัน คือ
                        ผู้ใช้ในเครือข่ายสามารถใช้ซอฟต์แวร์หรือชุดโปรแกรมชุดเดียวกันได้ จะทำให้เกิดมาตรฐานของซอฟต์แวร์มาตรฐานเดียวกัน
                        <Stack display="flex" mt="2" alignItems="center" py={{ base: 10, md: 18 }}>
                    ...
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#0002A1" p={6}>
                        1.3.1 ด้านบริการ การติดต่อสื่อสารในปัจจุบันมีช่องทางที่สามารถให้บริการผ่านระบบเครือข่ายคอมพิวเตอร์ได้สะดวก ส่งผลให้บริการต่าง
                        ๆ บนระบบเครือข่ายคอมพิวเตอร์ได้รับความนิยมเป็นอย่างมาก เนื่องจากการบริการดังกล่าวประหยัดสะดวกและรวดเร็วในการบริการ เช่น
                        เว็บไซต์ของกรมสรรพากรที่ให้บริการชำระภาษีผ่านอินเทอร์เน็ต หรือบริการจองตั๋วเครื่องบิน
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#0002A1" p={6}>
                        1.3.2 ด้านการสื่อสารข้อมูลและการจัดการ ในแต่ละหน่วยงานจะแยกออกเป็นฝ่าย แต่ละฝ่ายจะแยกย่อยออกไปตามขนาดของงาน เช่น
                        โรงงานอุตสาหกรรม ห้างสรรพสินค้า แต่ละแห่งมีระบบบริหารไม่เหมือนกัน
                        แต่สิ่งที่ทุกหน่วยงานมีเหมือนกันคือต้องมีการติดต่อสื่อสารและการบริหารจัดการภายในของหน่วยงาน
                        ที่จะต้องติดต่อสื่อสารระหว่างฝ่ายต่าง ๆ เพื่อให้เกิดประสิทธิภาพในการบริหารงานทั้งภายในและภายนอก
                        ถ้ามีการเชื่อมต่อผ่านเครือข่านคอมพิวเตอร์จะทำให้กการบริหารจัดการเกิดประสิทธิภาพมากขึ้น เช่น การบริการรับส่งข่าวสาร
                        และการประชุม เป็นต้น
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#0002A1" p={6}>
                    ...
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#0002A1" p={6}>
                        ...
                        ครูผู้สอนจะต้องค้นคว้าข้อมูลและวิทยาการใหม่ ๆ เพื่อนำความรู้มาถ่ายทอดให้ผู้เรียนได้อย่างมีประสิทธิภาพ
                    ...
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#0002A1" p={6}>
                        ...
                        มีการจัดเก็บประวัติผู้ป่วยที่มารักษาในโรงพบาบาล
                        ทำให้การรักษาพยาบาลมีประสิทธิภาพเพิ่มมากขึ้นตลอดจนเรื่องการวิจัยทางการแพทย์ใหม่ ๆ
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#0002A1" p={6}>
                    ...
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#0002A1" p={6}>
                        ...
                        โทรทัศน์ หรือสื่ออื่น ๆ เพื่อใช้เป็นช่องทางในการโฆษณาสินค้าแนะนำบริษัท สินค้าและบริการ หรือโซเชียลเน็กเวิร์ก (Social Network)
                        เช่น เฟซบุ๊ก หรือทางด้านการค้นหาข้อมูล เช่น กูเกิล (Google)
                    </Text>
                    ...
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E" p={6}>
                        1.4.1.1เครื่องแม่ข่ายหรือเซิร์ฟเวอร์ (Server)
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E">
                        ในระบบเครือข่ายแบบไคลเอนต์เซิร์ฟเวอร์จำเป็นต้องมีเครื่อง ๆ หนึ่งที่นำมาใช้เป็นเครื่องบริการ หน้าที่ของเครื่องแม่ข่าย คือ
                        การให้บริการทรัพยากรกับเครื่องลูกข่ายที่ได้ร้องขอเข้ามา เช่น การบริการไฟล์ข้อมูล การบริการงานพิมพ์ เป็นต้น
                        เครื่องแม่ข่ายสามารถเป็นได้ทั้งเคร่องระดับเมนเฟรม มินิคคอมพิวเตอร์ แต่สำหรับไมโครคอมพิวเตอร์ที่นำมาเป็นเครื่องแม่ข่ายนั้น
                        จะมีคุณสมบัติที่เหนือกว่าเครื่องพีซีทั่วไป เช่น ใช้ฮาร์ดดิก์แบบเอสซีเอสไอหรือสกัสซี (SCSI)
                        หน่วยความจำที่ใช้เป็นชนิดที่สามารถตรวจจับข้อผิดพลาดได้ รวมถึงการรองรับความทนทานต่อความผิดพลาด
                        เนื่องจากอาจจำเป็นต้องนำมาใช้งานตลอด 24 ชั่วโมง
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E" p={6}>
                        1.4.1.2สถานีงาน (Workstation)
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E">
                        เป็นเครื่องพีซีทั่วไปที่เชื่อมต่อกับเครือข่ายคอมพิวเตอร์ ทำหน้าที่เป็นสถานีปลายทาง เรียกว่า คอมพิวเตอร์ลูกข่าย
                        หลังจากที่เครื่องแม่ข่ายได้ทำการติดตั้งเรียบร้อยแล้ว เครื่องลูกข่ายต่าง ๆ ภายในเครือข่ายจะถูกติดตั้งขึ้นมา
                        ...
                        ดังนั้นจำเป็นต้องค้นหาจุดที่บกพร้องและแก้ไขโดยทันที
                        โดยหลังจากที่เครื่องลูกข่ายสามารถเชื่อมต่อเข้ากับเครื่องแม่ข่ายเรียบร้อยแล้ว
                        ขั้นตอนต่อไปเป็นหน้าที่ของผู้ดูแลระบบในการบริหารจัดการเครือข่าย โดยจะดำเนินการกำหนดบัญชีผู้ใช้ตามแต่ละแผนก
                        และกำหนดสิทธิการใช้งานบนเครือข่าย ส่วนระบบที่ใช้เครื่องคอมพิวเตอร์เมนเฟรมเป็นศูนย์กลางเรียกสถานีปลายทางว่า เทอร์มินัล
                        (Terminal) ประกอบด้วยจอภาพและแป้นพิมพ์ เป็นต้น
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E" p={6}>
                        1.4.2 อุปกรณ์สำหรับเครือข่ายคอมพิวเตอร์ (Hardware) การเชื่อมต่อเครือข่ายคอมพิวเตอร์มีปุกรณ์ที่เป็นส่วนประกอบสำคัญหลายอย่าง
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E" p={6}>
                        1.4.2.1เน็ตเวิร์กการ์ด (Network Interface Card: NIC)
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E">
                        เป็นจุดเชื่อมต่อระหว่างคอมพิวเตอร์และบบเครือข่ายคอมพิวเตอร์ เรียกว่า แลนการ์ด เป็นอุปกรณ์ที่สำคัญในการเชื่อมต่อเครือข่าย
                        ทำหน้าที่รับส่งข้อมูลระหว่างคอมพิวเตอร์ในเครือข่ายเน็ตเวิร์กการ์ดมี2 แบบ คือ เน็ตเวิร์กการ์ดแบบพีซีไอ (PCI)
                        มีความเร็วในการรับส่งข้อมูล 10 เมกะบิตต่อวินาที และ 100เมกะบิตต่อวินาที และเน็ตเวิร์กการ์ดอีกชนิดหนึ่งเป็นแบบไอเอสเอ (ISA)
                        `มีความเร็วในการรับส่งข้อมูล 10 เมกะบิตต่อวินาที ส่วนในแผงวงจรเครือข่ายจะมีขั้วสำหรับการเชื่อมต่อเข้ากับสายเคเบิลแบบต่าง ๆ
                        ได้แก่ ขั้วต่อแบบบีเอ็นซี (BNC) ขั้วต่อแบบอาร์เจ-45 (RJ-45)เป็นต้น
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E" p={6}>
                        1.4.2.2อุปกรณ์เพื่อการเชื่อมต่อเครือข่าย (Connecting Devices)
                        เป็นอุปกรณ์เชื่อมโยงที่มีให้สำหรับเชื่อมโยงระหว่างเครื่องคอมพิวเตอร์ เชื่องโยงระหว่างอุปกรณ์ เช่น ฮับ สวิตช์ เราท์เตอร์ บริดจ์
                        และเกตเวย์ เป็นต้น
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E" p={6}>
                        1.4.3 สื่อกลางสำหรับการสื่อสาร (Transmission Media)
                        การสื่อสารต้องมีสื่อกลางเพื่อเป็นตัวกลางสำหรับส่งข้อมูลระหว่างผู้ส่งและผู้รับ โดยจะส่งข้อมูลผ่านสื่อกลางประเภทต่าง ๆ เช่น
                        สายใยแก้วนำแสง สายเกลียวคู่ สายโคแอกเชียล คลื่นไมโครเวฟ คลื่นวิทยุ เป็นต้น ในการส่งข้อมูลผ่านช่องทางสื่อสารแบบต่าง ๆ
                        ขึ้นอยู่กับองค์ประกอบของผู้ใช้ว่าจะเลือกสื่อกลางแบบใด
                    </Text>
                    ...
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#251749" p={6}>
                        ...
                        ในกรณีดังกล่าวอาจต้องติดตั้งชุดติดตั้งเครื่องลูกข่ายโดยเฉพาะรวมถึงการตั้งค่าของระบบและกำหนดชนิดของโปรโทคอลที่ใช้งานให้ตรงกัน
                        เช่น เครื่องแม่ข่ายเป็นวินโดวส์เซิร์ฟเวอร์ 2003/2012 แต่เครื่องลูกข่ายเป็นวินโดวส์ 8 หรือวินโดวส์ 10 เป็นต้น
                    </Text>
                    <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#251749" p={6}>
                        ...
                        หรือข้อกำหนดเพื่อให้ผู้ส่งและผู้รับสามารถสื่อสารกันได้อย่างเข้าใจและส่งผลให้การสื่อสารทั้งสองฝ่ายเกิดผลสัมฤทธิ์ เช่น ทีซีพี
                        ไอพี (TCP/IP) เป็นโปรโทคอลที่ใช้ในระบบอินเทอร์เน็ต โดยมีการระบุผู้รับ ผู้ส่งในเครือข่าย
                    ...
                    <Text fontSize={"3xl"} color="#3D0000">
                        ...
                        เพื่อทำให้สามารถสื่อสาร แลกเปลี่ยนข้อมูล และใช้ทรัพยากรร่วมกันได้ สำหรับเครือข่ายคอมพิวเตอร์ แบ่งออกเป็น 2 ส่วน คือ
                        เครือข่ายย่อยในส่วนของผู้ใช้ และเครือข่ายย่อยในส่วนของการสื่อสาร จุดประสงค์ของระบบเครือข่าย
                        เพื่อการแลกเปลี่ยนข้อมูลอย่างมีประสิทธิภาพ การใช้ทรัพยากรร่วมกัน ลดต้นทุน สร้างความน่าเชื่อถือและความปลอดภัยของระบบ
                        ช่วยลดขั้นตอนการทำงาน และเพื่อความสะดวกในด้านการสื่อสาร เป็นต้น ประโยชน์ของระบบครือข่ายคอมพิวเตอร์ ประกอบด้วย การบริการ
                        การสื่อสารข้อมูล และการจัดการ ค่าใช้จ่าย ธุรกิจการเงิน การแลกเปลี่ยนข่าวสาร การศึกษาค้นคว้า การแพทย์ ด้านความบันเทิง
                        การโฆษณาประชาสัมพันธ์ เป็นต้น องค์ประกอบสำหรับระบบเครือข่าย ประกอบด้วย เครื่องคอมพิวเตอร์ อุปกรณ์สำหรับการสื่อสาร
                        สื่อกลางสำหรับการสื่อสาร โปรแกรมระบบปฏิบัติการเครือข่าย และโปรโทคอลสำหรับการสื่อสาร
                    </Text>
                </Box>
            </Container>
