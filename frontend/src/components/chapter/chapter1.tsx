    ...
    return (
        <Container maxW={"9xl"}>
            ...
            <Box gap={6} p={12}>
                ...
                <Heading fontSize={"2xl"} color="#0002A1">
                    1.1.2 ระบบเครือข่ายย่อนในส่วนของการสื่อสาร ระบบสื่อเครือข่ายนี้มีโหนดหลายโหนดติดต่อกันผ่านสื่อกลางข้อมูล
                    เพื่อส่งข้อมูลจากต้นทางไปยังปลายทาง สำหรับระบบเครือข่ายย่อยในส่วนของการสื่อสาร ประกอบด้วย
                </Heading>
                <Text fontSize={"2xl"} color="#0002A1">
                    1.โหนดเครือข่าย (Network Node) ทำหน้าที่เป็นตัวเชื่อมประสารงานกับเครือข่ายย่อยของผู้ใช้
                ...
                <Heading fontSize={"2xl"} color="#0002A1">
                    1.2 จุดประสงค์การใช้ระบบเครือข่ายคอมพิวเตอร์ เพื่อให้มีการแลกเปลี่ยนข้อมูลกันได้ระหว่างผู้ใช้อย่างมีประสิทธิภาพ
                    ใช้ทรัพยากรร่วมกันได้ สร้างความน่าเชื่อถือและความปลอดภัยของระบบ
                ...
                <Heading fontSize={"2xl"} color="#0002A1">
                    1.3 ประโยชน์ของระบบเครือข่ายคอมพิวเตอร์ ปัจจุบันการติดต่อสื่อสารผ่านระบบเครือข่ายมีความสำคัญมากขึ้นเรื่อย ๆ
                    ตามจุดประสงค์ในการติดตั้งเครือข่ายคอมพิวเตอร์ โดยประโยชน์ของเครือข่ายคอมพิวเตอร์สามารถแยกออกได้แต่ละด้าน ดังนี้
                </Heading>
                <Text fontSize={"2xl"} color="#0002A1">
                ...
                <Heading fontSize={"2xl"} color="#1A1A2E">
                    1.4 องค์ประกอบของระบบเครือข่ายคอมพิวเตอร์ เพื่อการเชื่อมต่อเป็นเครือข่ายคอมพิวเตอร์ ได้แก่ เครื่องคอมพิวเตอร์ อุปกรณ์
                    อุปกรณ์สำหรับเครือข่ายคอมพิวเตอร์ สื่อกลางสำหรับการสื่อสาร โปรแกรมระบบปฏิบัติการเครือข่าย และโปรโทคอลสำหรับการสื่อสาร
                </Heading>
                <Text fontSize={"2xl"} color="#1A1A2E">
                ...
                <Heading fontSize={"2xl"} color="#251749">
                    สื่อกลางส่งข้อมูลแบ่งเป็น 2 กลุ่ม
                </Heading>
                <Text fontSize={"2xl"} color="#251749">
                ...
                <Heading fontSize={"2xl"} color="#420516">
                    สรุปสาระสำคัญ
                </Heading>
                <Text fontSize={"2xl"} color="#3D0000">
