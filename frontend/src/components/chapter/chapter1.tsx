        ...
        <Container maxW={"9xl"}>
            ...
            <Box gap={6} p={12}>
                ...
                <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E">
                    ...
                    หน่วยความจำที่ใช้เป็นชนิดที่สามารถตรวจจับข้อผิดพลาดได้ รวมถึงการรองรับความทนทานต่อความผิดพลาด เนื่องจากอาจจำเป็นต้องนำมาใช้งานตลอด
                    24 ชั่วโมง
                </Text>
                <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E" p={6}>
                ...
                <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E">
                    ...
                    `มีความเร็วในการรับส่งข้อมูล 10 เมกะบิตต่อวินาที ส่วนในแผงวงจรเครือข่ายจะมีขั้วสำหรับการเชื่อมต่อเข้ากับสายเคเบิลแบบต่าง ๆ ได้แก่
                    ขั้วต่อแบบบีเอ็นซี (BNC) ขั้วต่อแบบอาร์เจ-45 (RJ-45)เป็นต้น
                </Text>
                <Text fontSize={{ base: "xl", sm: "3xl", md: "4xl" }} lineHeight={"110%"} color="#1A1A2E" p={6}>
